...
void main_window(){
    ...
    HWND hwndButton=CreateWindowExA(0,"BUTTON","打开窗口",WS_TABSTOP|WS_VISIBLE|WS_CHILD|BS_DEFPUSHBUTTON,
        110,25,50,50,hwnd,(HMENU)MAIN_BUTTON,hInstance,NULL);
    HWND hwndButton2=CreateWindowExA(0,"BUTTON","单步计算",WS_TABSTOP|WS_VISIBLE|WS_CHILD|BS_DEFPUSHBUTTON,
